...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-8">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                  ...
                  <button
                    ...
                    className="p-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors flex items-center shadow-md justify-center"
                    disabled={isLoading}
                  >
                    <Check className="w-5 h-5" />
                    <span className="ml-2 sm:ml-1 md:ml-2">Kryer</span>
                  </button>

                  {/* BUTONI "FSHIJ" */}
                  <button
                    onClick={() => handleDeleteBooking(booking.id)}
                    className="p-3 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors flex items-center shadow-md justify-center"
                    disabled={isLoading}
                  >
                    <Trash2 className="w-5 h-5" />
                    <span className="ml-2 sm:ml-1 md:ml-2">Fshij</span>
                  </button>
                </div>
      ...
      {toast.type && (
        <div
          className={`fixed bottom-5 right-5 z-[100] p-4 rounded-lg shadow-xl transition-opacity duration-300 ${
            toast.type === 'success'
